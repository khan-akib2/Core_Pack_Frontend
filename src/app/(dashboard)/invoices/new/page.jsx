    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-5xl mx-auto pb-12 antialiased">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900 tracking-tight">Generate GST Tax Invoice</h1>
            <p className="text-xs text-slate-500 mt-0.5">Customize fields, add transportation charges & issue tax bill</p>
          </div>
        </div>
